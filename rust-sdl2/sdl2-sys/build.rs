...
fn generate_bindings(target: &str, host: &str, headers_paths: &[String]) {
    ...
    let mut gfx_framerate_bindings = bindgen::Builder::default().use_core().ctypes_prefix("core::ffi");
    let mut gfx_primitives_bindings = bindgen::Builder::default()
        .use_core()
        .raw_line("use crate::*;")
        .ctypes_prefix("core::ffi");
    let mut gfx_imagefilter_bindings = bindgen::Builder::default().use_core().ctypes_prefix("core::ffi");
